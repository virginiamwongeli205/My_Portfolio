    ...
    <section id="home" className="pt-28 pb-16 bg-[#0A0A0A] text-white">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-[#111111] border border-[#1F1F1F] rounded-xl p-6 text-center">
            {[
              ...
              <div key={index}>
                ...
                <p className="text-[#A1A1AA] text-sm">{item.label}</p>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <div className="absolute w-[280px] h-[280px] md:w-[400px] md:h-[400px] bg-[#39FF14]/10 rounded-full blur-3xl"></div>

          <img
            src="/virginia.png"
            alt="hero"
            className="relative w-[260px] md:w-[350px] object-cover rounded-full border border-[#1F1F1F]"
          />
        </motion.div>
      </div>
    </section>
